  ...
  const removeProduct = (_id: number) => {
    ...
    const columns: ColumnsType<DataType> = [
        ...
        },
        {
          ...
          dataIndex: 'image' ,
          key: 'image',
          render: (text) => <img src={text} alt="product" style={{maxWidth: '100px'}}/>
        },
        {
          title: 'Desc',
          dataIndex: 'desc',
    ...
    return (
        ...
        <div>
            <Title level={2} style={{color :"Red",textAlign:'center'}} >Products</Title>
            <Button  style={{margin:20,textAlign:'center'}} type='primary'><Link to={'/admin/products/add'}>Add New Product</Link></Button>
